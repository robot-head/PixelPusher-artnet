...
=======
  // The ACN identifier string is defined to be "ASC-E1.17\0\0\0";
  public static final int ACN_IDENTIFIER_SIZE = 12;
  public static final byte[] ACN_IDENTIFIER = { 0x41, 0x53, 0x43, 0x2d, 0x45,
  ...
  public SacnReceiver(PixelPusherObserver observer) {
    ...
    try {
      ...
      // mcSocket.bind(new InetSocketAddress(InetAddress.getByName("0.0.0.0"),
      // SACN_PORT));
    } catch (IOException e1) {
      e1.printStackTrace();
    }
  ...
  public void run() {
    ...
    // SACN_PORT));
    // System.out.println("Listening for streaming ACN messages on " +
...
>>>>>>> 5ae33f84f7ec73452f3e0f9b612d35a914cf2433
}
